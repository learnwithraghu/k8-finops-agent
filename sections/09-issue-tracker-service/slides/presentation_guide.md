# Slide Presentation Guide: Section 09 Issue Tracker Service
...
*   **File**: [slide1_overview.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide1_overview.svg)
*   **Narrative Focus**:
...
*   **File**: [slide2_architecture.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide2_architecture.svg)
*   **Narrative Focus**:
...
*   **File**: [slide3_payload_schema.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide3_payload_schema.svg)
*   **Narrative Focus**:
...
*   **File**: [slide4_demo1.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide4_demo1.svg)
*   **Narrative Focus**:
    ...
    *   **Demo Steps**:
        1. Open a terminal and run the Docker build command:
           ```bash
           docker build -t finops-issue-tracker:latest sections/09-issue-tracker-service/service
           ```
...
*   **File**: [slide5_flow_handoff.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide5_flow_handoff.svg)
*   **Narrative Focus**:
...
*   **File**: [slide6_demo2.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide6_demo2.svg)
*   **Narrative Focus**:
...
*   **File**: [slide7_summary.svg](file:///Users/raghunandanask/Desktop/github-repo/k8-finops-agent/sections/09-issue-tracker-service/slides/slide7_summary.svg)
*   **Narrative Focus**:
    *   Recap Section 09 achievements: We have a functioning Kanban board that represents our tracking destination.
    *   Preview Section 10: We will link our LangChain Python Agent directly to this API. Instead of manual curls, the agent will analyze the cluster live and raise tickets automatically.
