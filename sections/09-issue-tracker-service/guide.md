# Section 09 Guide: Issue Tracker Service
...
- `sections/09-issue-tracker-service/service/`
...
```bash
find sections/09-issue-tracker-service/service -maxdepth 3 -type f | sort
```
...
- `sections/10-agent-to-tracker-integration/guide.md`

Section 10 connects the agent output to this tracker service.
