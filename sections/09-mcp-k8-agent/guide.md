# Section 09 Guide: Local MCP Server with curl Validation
...
- where compliance analysis gets layered on next (Section 10)

Note: the advanced collector / analyst / tracker flow lives in Section 10. This section only proves a clean, curl-validated MCP baseline.
...
- explain how this curl-validated MCP setup becomes the input seam for advanced workflows in Section 10