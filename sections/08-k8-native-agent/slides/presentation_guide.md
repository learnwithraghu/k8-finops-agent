# Slide Presentation Guide: Section 08 Helm-Based Deployment
...
*   **Narrative Focus**:
    *   Explain the evolution: In Section 05, we built an LLM-powered FinOps agent that runs locally. Now we're packaging it for production deployment inside Kubernetes.
...
*   **Narrative Focus**:
    ...
    *   Preview possible extensions:
        - Integrate with issue tracker (Section 07)
    ...
    *   Congratulate: Section 08 complete! The agent is now production-ready with professional packaging.
...
1. **Show the chart structure**: `tree sections/08-k8-native-agent/helm/`
2. **Inspect values.yaml**: `cat sections/08-k8-native-agent/helm/values.yaml`
...
5. **Lint the chart**: `helm lint sections/08-k8-native-agent/helm/`
6. **Install the chart**: `helm install finops-agent sections/08-k8-native-agent/helm/`
