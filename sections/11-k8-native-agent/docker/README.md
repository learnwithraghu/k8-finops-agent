...
This folder contains the container build for the Section 11 Kubernetes-native agent.

## Files
- `Dockerfile` — builds `finops-agent:latest` from the Section 08 agent code
