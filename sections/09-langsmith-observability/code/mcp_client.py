"""Shared LangChain + MCP helpers for Section 09 scripts.

Same agent path as Section 07. Tracing is env-only: set LANGSMITH_TRACING,
LANGSMITH_API_KEY, and LANGSMITH_PROJECT in the repo-root `.env` and LangChain
sends runs to LangSmith automatically — no extra Python wiring.
