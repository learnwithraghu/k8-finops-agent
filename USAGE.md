...
kubectl apply -f sections/10-k8-native-agent/cronjob/agent-job.yaml
...
- Review Section 06 scripts in `sections/06-mcp-data-agent/code/query_agent.py` and `label_auditor.py`
