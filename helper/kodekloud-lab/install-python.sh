...
print_info "Installing Section 08 dependencies..."
pip install -r "${REPO_ROOT}/sections/08-llm-agent-langchain/requirements.txt"
print_success "Section 08 dependencies installed"
...
echo ""
echo "  # Section 08"
echo "  PYTHONPATH=sections/08-llm-agent-langchain python3 -m agent.main"
echo ""
