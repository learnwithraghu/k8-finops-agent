...
print_info "Installing Section 04 dependencies..."
pip install -r "${REPO_ROOT}/sections/04-local-python-agent/requirements.txt"
print_success "Section 04 dependencies installed"

print_info "Installing Section 05 dependencies..."
pip install -r "${REPO_ROOT}/sections/05-llm-agent-langchain/requirements.txt"
print_success "Section 05 dependencies installed"

print_header "Python Setup Complete!"
echo -e "${GREEN}Virtual environment is active. Run your agents with:${NC}"
echo ""
echo "  # Section 04"
echo "  PYTHONPATH=sections/04-local-python-agent python3 -m agent.collect -o k8s_metadata.json"
echo ""
echo "  # Section 05"
echo "  PYTHONPATH=sections/05-llm-agent-langchain python3 -m agent.main"
echo ""
